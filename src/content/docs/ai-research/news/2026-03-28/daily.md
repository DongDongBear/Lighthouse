...
> 以下为 2026-03-27 日报提出的追踪问题的最新进展。

### 1. Anthropic 禁令后续：政府是否上诉？

**最新进展：** 政府尚未正式宣布上诉决定。但行业侧出现重大进展——37 名 Google/OpenAI 员工联名签署法庭之友意见书支持 Anthropic 对抗五角大楼"供应链风险"认定。Google 首席科学家 Jeff Dean 公开发推称"大规模监控违反第四修正案"。AI 安全护栏已形成跨公司行业共识，显著增加了政府上诉的政治成本。

**状态：** 🟡 持续关注。预计政府将在 30 天上诉期限内做出决定。

### 2. LiteLLM 供应链攻击的影响范围？

**最新进展：** 暂无公开更新。受影响用户的具体规模和攻击载荷的完整分析仍在进行中。PyPI 已移除恶意包，但下游影响评估尚未完成。

**状态：** 🔴 信息不足。建议关注 LiteLLM 官方安全公告和 CVE 数据库更新。

### 3. ARC-AGI-3 竞赛将如何发展？

**最新进展：** 暂无新的公开进展。竞赛仍在进行中，各参赛团队尚未公布突破性成果。ARC-AGI-3 的 Agent 模式（允许模型多轮交互和工具使用）仍是业界关注焦点。

**状态：** 🟡 持续关注。预计 Q2 将有首批高分方案公开。
