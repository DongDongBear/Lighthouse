...
**社区反馈**：
- 👍 HuggingFace 社区点赞，认为开源企业搜索 Agent 终于有了可复现的训练范式
- 👎 KARLBench 是自建 benchmark，外部可比性有待验证
...
**社区反馈**：
- 👍 HN 637 条评论，开发者认为 agentic workflow 终于实用了
- 👎 benchmark 自定义成分高，real-world 表现需更多验证
...
**社区反馈**：
- 👍 HN 386 点，安全社区认为这是 AI 工具安全的分水岭事件
- 👎 有人认为核心问题是权限配置，不应完全归咎于 AI

**行动建议**：立即审查所有 AI 自动化 workflow 的输入消毒和权限范围。

🔗 grith.ai/blog/clinejection-when-your-ai-tool-installs-another
...
🔗 anthropic.com/news/where-stand-department-war
